...
export const PERMISSION_INFO: Record<PermissionKey, { module: string; label: string; description: string }> = {
  ...
  newsletter: {
    ...
    description: "View the public newsletter signup list and send them news and updates.",
  },
  analytics: {
    module: "Analytics",
    label: "View site analytics",
    description: "See visitor counts, locations, and traffic over time for the public site.",
  },
  auditLog: {
    module: "Audit Log",
